...
\begin{document}
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{figs/criBackdrop.jpg}}
\begin{frame}
  \titlepage
\end{frame}
}
...
\item Beads are identified by Illumina using a decoding sequence
 \end{itemize}
\includegraphics[height=4cm,width=6cm]{figs/abead}
\end{frame}
...
\end{itemize}
\includegraphics[height=4cm,width=6cm]{figs/beadarrangement}
...
\end{itemize}
 \column{0.5\textwidth}
\includegraphics[height=4cm,width=6cm]{figs/chiptypes}
\end{columns}
...
\includegraphics[height=8cm,width=12cm]{figs/BeadPositions}
\end{frame}

\begin{frame}{Example}
Consider a technical failure on one of the arrays
\includegraphics[height=8cm,width=12cm]{figs/BeadPositionsWArtifact}
\end{frame}
...
\includegraphics[height=5cm,width=10cm]{figs/nicearray}
...
\includegraphics[height=6cm,width=4cm]{figs/beadleveltxt}
 \column{0.5\textwidth}
...
\includegraphics[height=4cm,width=10cm]{figs/BeadStudio}
...
\includegraphics[height=5cm,width=10cm]{figs/CombinedFigure1WithAnno}
...
\end{itemize}
\includegraphics[height=1.5cm,width=5cm]{figs/p95density}
\column{.5\textwidth}
\includegraphics[height=5cm,width=5cm]{figs/p95historical}
\end{columns}
\end{frame}
...
\end{itemize}
\column{.5\textwidth}
\includegraphics[height=5cm,width=5cm]{figs/imageprocessing}
\end{columns}
...
\includegraphics[width=8cm,height=6cm]{figs/thegood}
\end{frame}

\begin{frame}[t]{The bad..}
\includegraphics[width=8cm,height=6cm]{figs/thebad}
\end{frame}

\begin{frame}[t]{and the ugly..}
\includegraphics[width=8cm,height=6cm]{figs/theugly}
\end{frame}
...
\includegraphics[height=4cm,width=10cm]{figs/badarray}
...
\begin{frame}
\includegraphics[height=5cm,width=10cm]{figs/workflow.pdf}
...
\includegraphics[c,width=10cm,height=6cm]{figs/boxPlotNoNorm1}
\end{frame}

\begin{frame}[t]{Why normalise?}
We want to be measuring \textit{biological} rather than \textit{technical} variation.
\includegraphics[c,width=10cm,height=6cm]{figs/boxPlotNoNorm2}
\end{frame}
...
\end{itemize}
\column{.5\textwidth}
\includegraphics[width=5cm,height=4cm]{figs/bgNorm}
\end{columns}
...
\end{itemize}
  \column{.5\textwidth}
\includegraphics[width=5cm, height=5cm]{figs/DEboxplot}
  \end{columns}
\end{frame}
...
%%\includegraphics[width=10cm,height=2cm]{figs/genelist}

%%\includegraphics[width=10cm,height=2cm]{figs/genelist2}
...
\end{itemize}
\column{.5\textwidth}
\includegraphics[width=5cm,height=5cm]{figs/classification}
...
\end{itemize}
\column{.5\textwidth}
\includegraphics[width=5cm,height=5cm]{figs/erbb2levels}
\end{columns} 
...
\includegraphics[width=10cm,height=5cm]{figs/erbb2probes}
 

\end{frame}

\begin{frame}{Difference between subtypes}
\includegraphics[width=10cm,height=5cm]{figs/erbb2subtypes}
\end{frame}

\begin{frame}{Using external data}
\includegraphics[width=10cm,height=5cm]{figs/erbb2heatmaps}
\end{frame}

\begin{frame}[t]{An annotation pipeline}
\includegraphics[width=10cm,height=5cm]{figs/annotPipeline}
\end{frame}
...
\end{itemize}
\column{.5\textwidth}
\includegraphics[width=5cm,height=5cm]{figs/IntensityvsAnnot}
\end{columns}
\end{frame}
...
%%\end{frame}
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{figs/balloons.jpg}}
\begin{frame}{The End}
